...
public class InterpolationSmoothTesting extends Component implements ActionListener {
	...
	public InterpolationSmoothTesting() {
		try {
	...
	*/
	...
	public static void main(String s[]) {
		...
		// p1 = new JPanel();
		final InterpolationSmoothTesting si = new InterpolationSmoothTesting();
		// p1.add(si);
		f.add("Center", si);
